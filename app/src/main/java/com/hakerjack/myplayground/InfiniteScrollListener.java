...
public abstract class InfiniteScrollListener implements AbsListView.OnScrollListener {
    ...
    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        Log.i("KJ", "firstVisible Item:" + firstVisibleItem + " visibleItemCount:" + visibleItemCount + " totalItemCount:" + totalItemCount);
        ...
        if (!loading && (totalItemCount - (firstVisibleItem + visibleItemCount) <= visibleThreshold)) {
            loading = loadMore(currentPage + 1, totalItemCount);
        }
    }
